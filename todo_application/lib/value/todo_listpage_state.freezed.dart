...
part of 'todo_listpage_state.dart';
...
class _$_TodoListPageState
  ...
  const _$_TodoListPageState({required this.selecteddate});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TodoListPageState(selecteddate: $selecteddate)';
  }
...
abstract class _TodoListPageState implements TodoListPageState {
  const factory _TodoListPageState({required final DateTime selecteddate}) =
